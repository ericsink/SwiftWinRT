...
public class CryptographicBuffer
{
    ...
    public static func Compare(object1 : Optional<WinRT.Windows.Storage.Streams.IBuffer>, object2 : Optional<WinRT.Windows.Storage.Streams.IBuffer>) throws -> boolean {
        return try CryptographicBufferStatics.Compare(object1: object1, object2: object2);
    }
    public static func GenerateRandom(length : Swift.UInt32) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
    ...
    public static func CreateFromByteArray(valueLength : UINT32, value : Optional<UnsafeMutablePointer<UINT8>>) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        return try CryptographicBufferStatics.CreateFromByteArray(valueLength: valueLength, value: value);
    }
    public static func CopyToByteArray(buffer : Optional<WinRT.Windows.Storage.Streams.IBuffer>, valueLength : inout UINT32, value : inout Optional<UnsafeMutablePointer<UINT8>>) throws -> Void {
    ...
    public static func DecodeFromHexString(value : Swift.String) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
    ...
    public static func DecodeFromBase64String(value : Swift.String) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
    ...
    public static func ConvertStringToBinary(value : Swift.String, encoding : WinRT.Windows.Security.Cryptography.BinaryStringEncoding) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        return try CryptographicBufferStatics.ConvertStringToBinary(value: value, encoding: encoding);
    }
    public static func ConvertBinaryToString(encoding : WinRT.Windows.Security.Cryptography.BinaryStringEncoding, buffer : Optional<WinRT.Windows.Storage.Streams.IBuffer>) throws -> Swift.String {
    ...
    WinRT.IInspectable
{
    ...
    public func Compare(object1 : Optional<WinRT.Windows.Storage.Streams.IBuffer>, object2 : Optional<WinRT.Windows.Storage.Streams.IBuffer>) throws -> boolean {
    ...
    public func GenerateRandom(length : Swift.UInt32) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
    ...
    public func CreateFromByteArray(valueLength : UINT32, value : Optional<UnsafeMutablePointer<UINT8>>) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CStorage_CStreams_CIBuffer>> = nil;
    ...
    public func CopyToByteArray(buffer : Optional<WinRT.Windows.Storage.Streams.IBuffer>, valueLength : inout UINT32, value : inout Optional<UnsafeMutablePointer<UINT8>>) throws -> Void {
            var _tmp_out_valueLength: UINT32 = 0;
            var _tmp_out_value: Optional<UnsafeMutablePointer<UINT8>> = nil;
    ...
    public func DecodeFromHexString(value : Swift.String) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        let __hstr_value = try HString(value);
        return try withExtendedLifetime(__hstr_value) {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CStorage_CStreams_CIBuffer>> = nil;
        try self._n_DecodeFromHexString(__hstr_value.hRef.hString, &__result);
        return WinRT.Windows.Storage.Streams.IBuffer(consuming: __result);
        }
    }
    ...
    public func DecodeFromBase64String(value : Swift.String) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        let __hstr_value = try HString(value);
        return try withExtendedLifetime(__hstr_value) {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CStorage_CStreams_CIBuffer>> = nil;
        try self._n_DecodeFromBase64String(__hstr_value.hRef.hString, &__result);
        return WinRT.Windows.Storage.Streams.IBuffer(consuming: __result);
        }
    }
    ...
    public func ConvertStringToBinary(value : Swift.String, encoding : WinRT.Windows.Security.Cryptography.BinaryStringEncoding) throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        let __hstr_value = try HString(value);
        return try withExtendedLifetime(__hstr_value) {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CStorage_CStreams_CIBuffer>> = nil;
        try self._n_ConvertStringToBinary(__hstr_value.hRef.hString, encoding, &__result);
        return WinRT.Windows.Storage.Streams.IBuffer(consuming: __result);
        }
    }
    ...
    public func ConvertBinaryToString(encoding : WinRT.Windows.Security.Cryptography.BinaryStringEncoding, buffer : Optional<WinRT.Windows.Storage.Streams.IBuffer>) throws -> Swift.String {
        var __result : Optional<HSTRING> = nil;
...
extension WinRT.Windows.Security.Cryptography.BinaryStringEncoding {
