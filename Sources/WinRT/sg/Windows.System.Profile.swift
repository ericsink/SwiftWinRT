    ...
    WinRT.IInspectable
{
    ...
    public func _n_get_Id(_ __presult: UnsafeMutablePointer<Optional<UnsafeMutablePointer<__q_CWindows_CStorage_CStreams_CIBuffer>>>?) throws {
        return try perform(as: __q_CWindows_CSystem_CProfile_CISystemIdentificationInfo.self) { pThis in
    ...
    public func get_Id() throws -> Optional<WinRT.Windows.Storage.Streams.IBuffer> {
        var __result : Optional<UnsafeMutablePointer<__q_CWindows_CStorage_CStreams_CIBuffer>> = nil;
    ...
    WinRT.IInspectable
{
    ...
    public func _n_GetSystemIdForPublisher(_ __presult: UnsafeMutablePointer<Optional<UnsafeMutablePointer<__q_CWindows_CSystem_CProfile_CISystemIdentificationInfo>>>?) throws {
        return try perform(as: __q_CWindows_CSystem_CProfile_CISystemIdentificationStatics.self) { pThis in
    ...
    public func GetSystemIdForPublisher() throws -> Optional<WinRT.Windows.System.Profile.ISystemIdentificationInfo> {
        var __result : Optional<UnsafeMutablePointer<__q_CWindows_CSystem_CProfile_CISystemIdentificationInfo>> = nil;
    ...
    public func _n_GetSystemIdForUser(_ user : Optional<UnsafeMutablePointer<__q_CWindows_CSystem_CIUser>>, _ __presult: UnsafeMutablePointer<Optional<UnsafeMutablePointer<__q_CWindows_CSystem_CProfile_CISystemIdentificationInfo>>>?) throws {
        return try perform(as: __q_CWindows_CSystem_CProfile_CISystemIdentificationStatics.self) { pThis in
