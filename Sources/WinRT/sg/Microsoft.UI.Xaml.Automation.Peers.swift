...
{
    private var _self : WinRT.Microsoft.UI.Xaml.Automation.Peers.IAutomationPeer;
    internal init(plok: WinRT.Microsoft.UI.Xaml.Automation.Peers.IAutomationPeer?) throws {
        _self = plok!
    ...
    WinRT.IInspectable
{
    ...
    public func CreateInstance(baseInterface : Optional<WinRT.IInspectable>, innerInterface : inout Optional<WinRT.IInspectable>) throws -> Optional<WinRT.Microsoft.UI.Xaml.Automation.Peers.IAutomationPeer> {
