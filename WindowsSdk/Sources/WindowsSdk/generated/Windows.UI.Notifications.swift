    ...
    WinRT.IInspectable
{
    ...
    public func CreateNotificationDataWithValuesAndSequenceNumber(initialValues : Optional<ClosedGenerics.IIterable_1__cg_CWindows_CFoundation_CCollections_IKeyValuePair_2_HSTRING_HSTRING>, sequenceNumber : Swift.UInt32) throws -> Optional<Windows.UI.Notifications.INotificationData> {
        ...
        return Windows.UI.Notifications.INotificationData(consuming: __result);
    }
    ...
    public func CreateNotificationDataWithValues(initialValues : Optional<ClosedGenerics.IIterable_1__cg_CWindows_CFoundation_CCollections_IKeyValuePair_2_HSTRING_HSTRING>) throws -> Optional<Windows.UI.Notifications.INotificationData> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CUI_CNotifications_CINotificationData>> = nil;
    ...
    WinRT.IInspectable
{
    ...
    public func CreateScheduledToastNotification(content : Optional<Windows.Data.Xml.Dom.IXmlDocument>, deliveryTime : Windows.Foundation.DateTime) throws -> Optional<Windows.UI.Notifications.IScheduledToastNotification> {
        ...
        return Windows.UI.Notifications.IScheduledToastNotification(consuming: __result);
    }
    ...
    public func CreateScheduledToastNotificationRecurring(content : Optional<Windows.Data.Xml.Dom.IXmlDocument>, deliveryTime : Windows.Foundation.DateTime, snoozeInterval : Windows.Foundation.TimeSpan, maximumSnoozeCount : Swift.UInt32) throws -> Optional<Windows.UI.Notifications.IScheduledToastNotification> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CUI_CNotifications_CIScheduledToastNotification>> = nil;
    ...
    WinRT.IInspectable
{
    ...
    public func get_Content() throws -> Optional<Windows.Data.Xml.Dom.IXmlDocument> {
    ...
    public func put_ExpirationTime(value : Optional<ClosedGenerics.IReference_1__q_CWindows_CFoundation_CDateTime>) throws -> Void {
    ...
    public func get_ExpirationTime() throws -> Optional<ClosedGenerics.IReference_1__q_CWindows_CFoundation_CDateTime> {
    ...
    public func add_Dismissed(handler : Optional<ClosedGenerics.ITypedEventHandler_2__q_CWindows_CUI_CNotifications_CToastNotification__q_CWindows_CUI_CNotifications_CToastDismissedEventArgs>) throws -> Windows.Foundation.EventRegistrationToken {
    ...
    public func add_Activated(handler : Optional<ClosedGenerics.ITypedEventHandler_2__q_CWindows_CUI_CNotifications_CToastNotification_IInspectable>) throws -> Windows.Foundation.EventRegistrationToken {
        var __result : _q_CWindows_CFoundation_CEventRegistrationToken = _q_CWindows_CFoundation_CEventRegistrationToken(Value: 0);
    ...
    public func add_Failed(handler : Optional<ClosedGenerics.ITypedEventHandler_2__q_CWindows_CUI_CNotifications_CToastNotification__q_CWindows_CUI_CNotifications_CToastFailedEventArgs>) throws -> Windows.Foundation.EventRegistrationToken {
        var __result : _q_CWindows_CFoundation_CEventRegistrationToken = _q_CWindows_CFoundation_CEventRegistrationToken(Value: 0);
    ...
    public var Content : Optional<Windows.Data.Xml.Dom.IXmlDocument> {
        get throws {
    ...
    WinRT.IInspectable
{
    ...
    public func put_NotificationMirroring(value : Windows.UI.Notifications.NotificationMirroring) throws -> Void {
    ...
    WinRT.IInspectable
{
    ...
    public func get_Data() throws -> Optional<Windows.UI.Notifications.INotificationData> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CUI_CNotifications_CINotificationData>> = nil;
    ...
    public func put_Data(value : Optional<Windows.UI.Notifications.INotificationData>) throws -> Void {
    ...
    public func get_Priority() throws -> Windows.UI.Notifications.ToastNotificationPriority {
    ...
    public func put_Priority(value : Windows.UI.Notifications.ToastNotificationPriority) throws -> Void {
        try self._n_put_Priority(value);
    }
    public var Data : Optional<Windows.UI.Notifications.INotificationData> {
        get throws {
            return try get_Data();
        }
    }
    ...
    WinRT.IInspectable
{
    ...
    public func CreateToastNotification(content : Optional<Windows.Data.Xml.Dom.IXmlDocument>) throws -> Optional<Windows.UI.Notifications.IToastNotification> {
    ...
    WinRT.IInspectable
{
    ...
    public func CreateToastNotifier() throws -> Optional<Windows.UI.Notifications.IToastNotifier> {
        ...
        return Windows.UI.Notifications.IToastNotifier(consuming: __result);
    }
    ...
    public func GetTemplateContent(type : Windows.UI.Notifications.ToastTemplateType) throws -> Optional<Windows.Data.Xml.Dom.IXmlDocument> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CData_CXml_CDom_CIXmlDocument>> = nil;
    ...
    WinRT.IInspectable
{
    ...
    public func get_History() throws -> Optional<Windows.UI.Notifications.IToastNotificationHistory> {
        ...
        return Windows.UI.Notifications.IToastNotificationHistory(consuming: __result);
    }
    public var History : Optional<Windows.UI.Notifications.IToastNotificationHistory> {
        get throws {
    ...
    WinRT.IInspectable
{
    ...
    public func GetForUser(user : Optional<Windows.System.IUser>) throws -> Optional<Windows.UI.Notifications.IToastNotificationManagerForUser> {
        ...
        return Windows.UI.Notifications.IToastNotificationManagerForUser(consuming: __result);
    }
    ...
    public func ConfigureNotificationMirroring(value : Windows.UI.Notifications.NotificationMirroring) throws -> Void {
    ...
    WinRT.IInspectable
{
    ...
    public func GetDefault() throws -> Optional<Windows.UI.Notifications.IToastNotificationManagerForUser> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CUI_CNotifications_CIToastNotificationManagerForUser>> = nil;
    ...
    WinRT.IInspectable
{
    ...
    public func Show(notification : Optional<Windows.UI.Notifications.IToastNotification>) throws -> Void {
    ...
    public func Hide(notification : Optional<Windows.UI.Notifications.IToastNotification>) throws -> Void {
    ...
    public func get_Setting() throws -> Windows.UI.Notifications.NotificationSetting {
    ...
    public func AddToSchedule(scheduledToast : Optional<Windows.UI.Notifications.IScheduledToastNotification>) throws -> Void {
    ...
    public func RemoveFromSchedule(scheduledToast : Optional<Windows.UI.Notifications.IScheduledToastNotification>) throws -> Void {
    ...
    public func GetScheduledToastNotifications() throws -> Optional<ClosedGenerics.IVectorView_1__q_CWindows_CUI_CNotifications_CScheduledToastNotification> {
        ...
        return ClosedGenerics.IVectorView_1__q_CWindows_CUI_CNotifications_CScheduledToastNotification(consuming: __result);
    }
    ...
    WinRT.IInspectable
{
    ...
    public func add_ScheduledToastNotificationShowing(handler : Optional<ClosedGenerics.ITypedEventHandler_2__q_CWindows_CUI_CNotifications_CToastNotifier__q_CWindows_CUI_CNotifications_CScheduledToastNotificationShowingEventArgs>) throws -> Windows.Foundation.EventRegistrationToken {
        var __result : _q_CWindows_CFoundation_CEventRegistrationToken = _q_CWindows_CFoundation_CEventRegistrationToken(Value: 0);
...
public class NotificationData
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.INotificationData;
    public init(plok: Windows.UI.Notifications.INotificationData?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.INotificationData { return _self; }
    public init(initialValues : Optional<ClosedGenerics.IIterable_1__cg_CWindows_CFoundation_CCollections_IKeyValuePair_2_HSTRING_HSTRING>, sequenceNumber : Swift.UInt32) throws {
    ...
    public init(initialValues : Optional<ClosedGenerics.IIterable_1__cg_CWindows_CFoundation_CCollections_IKeyValuePair_2_HSTRING_HSTRING>) throws {
        let _af : INotificationDataFactory = try RoGetActivationFactory("Windows.UI.Notifications.NotificationData");
...
public class ScheduledToastNotification
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IScheduledToastNotification;
    public init(plok: Windows.UI.Notifications.IScheduledToastNotification?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IScheduledToastNotification { return _self; }
    public init(content : Optional<Windows.Data.Xml.Dom.XmlDocument>, deliveryTime : Windows.Foundation.DateTime) throws {
    ...
    public init(content : Optional<Windows.Data.Xml.Dom.XmlDocument>, deliveryTime : Windows.Foundation.DateTime, snoozeInterval : Windows.Foundation.TimeSpan, maximumSnoozeCount : Swift.UInt32) throws {
        let _af : IScheduledToastNotificationFactory = try RoGetActivationFactory("Windows.UI.Notifications.ScheduledToastNotification");
...
public class ScheduledToastNotificationShowingEventArgs
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IScheduledToastNotificationShowingEventArgs;
    public init(plok: Windows.UI.Notifications.IScheduledToastNotificationShowingEventArgs?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IScheduledToastNotificationShowingEventArgs { return _self; }
    // method not needed: get_Cancel
    // method not needed: put_Cancel
    // method not needed: get_ScheduledToastNotification
    // method not needed: GetDeferral
...
public class ToastDismissedEventArgs
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastDismissedEventArgs;
    public init(plok: Windows.UI.Notifications.IToastDismissedEventArgs?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastDismissedEventArgs { return _self; }
    // method not needed: get_Reason
}
...
public class ToastFailedEventArgs
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastFailedEventArgs;
    public init(plok: Windows.UI.Notifications.IToastFailedEventArgs?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastFailedEventArgs { return _self; }
    // method not needed: get_ErrorCode
}
...
public class ToastNotification
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastNotification;
    public init(plok: Windows.UI.Notifications.IToastNotification?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastNotification { return _self; }
    ...
    public func get_Content() throws -> Optional<Windows.Data.Xml.Dom.XmlDocument> {
        let _ifc : Windows.UI.Notifications.IToastNotification = try _self.QueryInterface();
        return try Windows.Data.Xml.Dom.XmlDocument(plok: _ifc.get_Content());
    }
    public func put_ExpirationTime(value : Optional<ClosedGenerics.IReference_1__q_CWindows_CFoundation_CDateTime>) throws -> Void {
        let _ifc : Windows.UI.Notifications.IToastNotification = try _self.QueryInterface();
    ...
    public func get_Data() throws -> Optional<Windows.UI.Notifications.NotificationData> {
        ...
        return try Windows.UI.Notifications.NotificationData(plok: _ifc.get_Data());
    }
    public func put_Data(value : Optional<Windows.UI.Notifications.NotificationData>) throws -> Void {
        let _ifc : Windows.UI.Notifications.IToastNotification4 = try _self.QueryInterface();
...
public class ToastNotificationHistory
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastNotificationHistory;
    public init(plok: Windows.UI.Notifications.IToastNotificationHistory?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastNotificationHistory { return _self; }
...
public class ToastNotificationManager
{
    ...
    public static func GetDefault() throws -> Optional<Windows.UI.Notifications.ToastNotificationManagerForUser> {
        return try Windows.UI.Notifications.ToastNotificationManagerForUser(plok: ToastNotificationManagerStatics5.GetDefault());
    }
    ...
    public static func get_History() throws -> Optional<Windows.UI.Notifications.ToastNotificationHistory> {
        return try Windows.UI.Notifications.ToastNotificationHistory(plok: ToastNotificationManagerStatics2.get_History());
    }
    public static var History : Optional<Windows.UI.Notifications.ToastNotificationHistory> {
        get throws {
        return try Windows.UI.Notifications.ToastNotificationHistory(plok: ToastNotificationManagerStatics2.History);
        }
    }
    ...
    public static func CreateToastNotifier() throws -> Optional<Windows.UI.Notifications.ToastNotifier> {
        return try Windows.UI.Notifications.ToastNotifier(plok: ToastNotificationManagerStatics.CreateToastNotifier());
    }
    public static func CreateToastNotifier(applicationId : Swift.String) throws -> Optional<Windows.UI.Notifications.ToastNotifier> {
        return try Windows.UI.Notifications.ToastNotifier(plok: ToastNotificationManagerStatics.CreateToastNotifierWithId(applicationId: applicationId));
    }
    public static func GetTemplateContent(type : Windows.UI.Notifications.ToastTemplateType) throws -> Optional<Windows.Data.Xml.Dom.XmlDocument> {
        return try Windows.Data.Xml.Dom.XmlDocument(plok: ToastNotificationManagerStatics.GetTemplateContent(type: type));
    }
    ...
    public static func GetForUser(user : Optional<Windows.System.User>) throws -> Optional<Windows.UI.Notifications.ToastNotificationManagerForUser> {
        return try Windows.UI.Notifications.ToastNotificationManagerForUser(plok: ToastNotificationManagerStatics4.GetForUser(user: user!.Interface()));
    }
    public static func ConfigureNotificationMirroring(value : Windows.UI.Notifications.NotificationMirroring) throws -> Void {
...
public class ToastNotificationManagerForUser
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastNotificationManagerForUser;
    public init(plok: Windows.UI.Notifications.IToastNotificationManagerForUser?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastNotificationManagerForUser { return _self; }
    // method not needed: CreateToastNotifier
    // method not needed: CreateToastNotifier
    // method not needed: get_History
    // method not needed: get_User
...
public class ToastNotifier
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Notifications.IToastNotifier;
    public init(plok: Windows.UI.Notifications.IToastNotifier?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Notifications.IToastNotifier { return _self; }
    public func Show(notification : Optional<Windows.UI.Notifications.ToastNotification>) throws -> Void {
    ...
    public func Hide(notification : Optional<Windows.UI.Notifications.ToastNotification>) throws -> Void {
        let _ifc : Windows.UI.Notifications.IToastNotifier = try _self.QueryInterface();
    ...
    public func AddToSchedule(scheduledToast : Optional<Windows.UI.Notifications.ScheduledToastNotification>) throws -> Void {
        let _ifc : Windows.UI.Notifications.IToastNotifier = try _self.QueryInterface();
        return try _ifc.AddToSchedule(scheduledToast: scheduledToast!.Interface());
    }
    public func RemoveFromSchedule(scheduledToast : Optional<Windows.UI.Notifications.ScheduledToastNotification>) throws -> Void {
        let _ifc : Windows.UI.Notifications.IToastNotifier = try _self.QueryInterface();
    ...
    public func Update(data : Optional<Windows.UI.Notifications.NotificationData>, tag : Swift.String, group : Swift.String) throws -> Windows.UI.Notifications.NotificationUpdateResult {
        let _ifc : Windows.UI.Notifications.IToastNotifier2 = try _self.QueryInterface();
        return try _ifc.UpdateWithTagAndGroup(data: data!.Interface(), tag: tag, group: group);
    }
    public func Update(data : Optional<Windows.UI.Notifications.NotificationData>, tag : Swift.String) throws -> Windows.UI.Notifications.NotificationUpdateResult {
        let _ifc : Windows.UI.Notifications.IToastNotifier2 = try _self.QueryInterface();
...
extension Windows.UI.Notifications.NotificationMirroring {
...
extension Windows.UI.Notifications.NotificationSetting {
...
extension Windows.UI.Notifications.NotificationUpdateResult {
...
extension Windows.UI.Notifications.ToastNotificationPriority {
...
extension Windows.UI.Notifications.ToastTemplateType {
