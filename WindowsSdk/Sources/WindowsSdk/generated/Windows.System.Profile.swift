    ...
    WinRT.IInspectable
{
    ...
    public func get_Source() throws -> Windows.System.Profile.SystemIdentificationSource {
    ...
    WinRT.IInspectable
{
    ...
    public func GetSystemIdForPublisher() throws -> Optional<Windows.System.Profile.ISystemIdentificationInfo> {
        ...
        return Windows.System.Profile.ISystemIdentificationInfo(consuming: __result);
    }
    ...
    public func GetSystemIdForUser(user : Optional<Windows.System.IUser>) throws -> Optional<Windows.System.Profile.ISystemIdentificationInfo> {
        var __result : Optional<UnsafeMutablePointer<_q_CWindows_CSystem_CProfile_CISystemIdentificationInfo>> = nil;
...
public class SystemIdentification
{
    ...
    public static func GetSystemIdForPublisher() throws -> Optional<Windows.System.Profile.SystemIdentificationInfo> {
        return try Windows.System.Profile.SystemIdentificationInfo(plok: SystemIdentificationStatics.GetSystemIdForPublisher());
    }
    public static func GetSystemIdForUser(user : Optional<Windows.System.User>) throws -> Optional<Windows.System.Profile.SystemIdentificationInfo> {
        return try Windows.System.Profile.SystemIdentificationInfo(plok: SystemIdentificationStatics.GetSystemIdForUser(user: user!.Interface()));
    }
}
...
public class SystemIdentificationInfo
    ...
    WinRT.Object
{
    private var _self : Windows.System.Profile.ISystemIdentificationInfo;
    public init(plok: Windows.System.Profile.ISystemIdentificationInfo?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.System.Profile.ISystemIdentificationInfo { return _self; }
    public func get_Id() throws -> Optional<Windows.Storage.Streams.IBuffer> {
...
extension Windows.System.Profile.SystemIdentificationSource {
