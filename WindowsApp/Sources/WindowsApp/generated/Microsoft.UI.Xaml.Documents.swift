    ...
    WinRT.IInspectable
{
    ...
    public func CreateInstance(baseInterface : Optional<WinRT.IInspectable>, innerInterface : inout Optional<WinRT.IInspectable>) throws -> Optional<Microsoft.UI.Xaml.Documents.IInline> {
    ...
    WinRT.IInspectable
{
    ...
    public func CreateInstance(baseInterface : Optional<WinRT.IInspectable>, innerInterface : inout Optional<WinRT.IInspectable>) throws -> Optional<Microsoft.UI.Xaml.Documents.ITextHighlighter> {
...
{
    private var _self : Microsoft.UI.Xaml.Documents.IInline;
    public init(plok: Microsoft.UI.Xaml.Documents.IInline?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Documents.IInline { return _self; }
...
public class InlineCollection
    ...
    WinRT.Object
{
    private var _self : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline;
    public init(plok: ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline { return _self; }
    public func GetAt(index : Swift.UInt32) throws -> Optional<Microsoft.UI.Xaml.Documents.Inline> {
        let _ifc : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline = try _self.QueryInterface();
        return try Microsoft.UI.Xaml.Documents.Inline(plok: _ifc.GetAt(index: index));
    }
    ...
    public func IndexOf(value : Optional<Microsoft.UI.Xaml.Documents.Inline>, index : inout Swift.UInt32) throws -> boolean {
        let _ifc : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline = try _self.QueryInterface();
            var _tmp_out_index: Swift.UInt32 = 0;
        return try _ifc.IndexOf(value: value!.Interface(), index: &_tmp_out_index);
    }
    public func SetAt(index : Swift.UInt32, value : Optional<Microsoft.UI.Xaml.Documents.Inline>) throws -> Void {
        let _ifc : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline = try _self.QueryInterface();
        return try _ifc.SetAt(index: index, value: value!.Interface());
    }
    public func InsertAt(index : Swift.UInt32, value : Optional<Microsoft.UI.Xaml.Documents.Inline>) throws -> Void {
        let _ifc : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline = try _self.QueryInterface();
    ...
    public func Append(value : Optional<Microsoft.UI.Xaml.Documents.Inline>) throws -> Void {
        let _ifc : ClosedGenerics.IVector_1__q_CMicrosoft_CUI_CXaml_CDocuments_CInline = try _self.QueryInterface();
...
{
    private var _self : Microsoft.UI.Xaml.Documents.ITextElement;
    public init(plok: Microsoft.UI.Xaml.Documents.ITextElement?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Documents.ITextElement { return _self; }
...
open class TextHighlighter
    ...
    WinRT.Object
{
    private var _self : Microsoft.UI.Xaml.Documents.ITextHighlighter;
    public init(plok: Microsoft.UI.Xaml.Documents.ITextHighlighter?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Documents.ITextHighlighter { return _self; }
...
public class TextPointer
    ...
    WinRT.Object
{
    private var _self : Microsoft.UI.Xaml.Documents.ITextPointer;
    public init(plok: Microsoft.UI.Xaml.Documents.ITextPointer?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Documents.ITextPointer { return _self; }
    // method not needed: get_Parent
    // method not needed: get_VisualParent
    // method not needed: get_LogicalDirection
    // method not needed: get_Offset
