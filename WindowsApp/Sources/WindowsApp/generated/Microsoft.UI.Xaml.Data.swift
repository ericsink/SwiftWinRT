...
{
    private var _self : Microsoft.UI.Xaml.Data.IBindingBase;
    public init(plok: Microsoft.UI.Xaml.Data.IBindingBase?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Data.IBindingBase { return _self; }
...
{
    private var _self : Microsoft.UI.Xaml.Data.IBindingExpression;
    public init(plok: Microsoft.UI.Xaml.Data.IBindingExpression?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Data.IBindingExpression { return _self; }
...
open class BindingExpressionBase
    ...
    WinRT.Object
{
    private var _self : Microsoft.UI.Xaml.Data.IBindingExpressionBase;
    public init(plok: Microsoft.UI.Xaml.Data.IBindingExpressionBase?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Data.IBindingExpressionBase { return _self; }
    ...
    WinRT.IInspectable
{
    ...
    public func CreateInstance(baseInterface : Optional<WinRT.IInspectable>, innerInterface : inout Optional<WinRT.IInspectable>) throws -> Optional<Microsoft.UI.Xaml.Data.IBindingBase> {
        ...
        return Microsoft.UI.Xaml.Data.IBindingBase(consuming: __result);
    }
} // IBindingBaseFactory
