    ...
    WinRT.IInspectable
{
    ...
    public func CreateInstance(baseInterface : Optional<WinRT.IInspectable>, innerInterface : inout Optional<WinRT.IInspectable>) throws -> Optional<Microsoft.UI.Xaml.Media.Media3D.ITransform3D> {
...
{
    private var _self : Microsoft.UI.Xaml.Media.Media3D.ITransform3D;
    public init(plok: Microsoft.UI.Xaml.Media.Media3D.ITransform3D?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Microsoft.UI.Xaml.Media.Media3D.ITransform3D { return _self; }
