...
public class CoreDispatcher
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Core.ICoreDispatcher;
    public init(plok: Windows.UI.Core.ICoreDispatcher?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Core.ICoreDispatcher { return _self; }
...
public class CoreWindow
    ...
    WinRT.Object
{
    private var _self : Windows.UI.Core.ICoreWindow;
    public init(plok: Windows.UI.Core.ICoreWindow?) throws {
        _self = plok!
        try super.init(plok: _self.QueryInterface())
    }
    public func Interface() -> Windows.UI.Core.ICoreWindow { return _self; }
